...
1. Suchen Sie den Kommentar **Mit dem Agent-Client verbinden** und fügen Sie den folgenden Code hinzu, um eine Verbindung zum Azure KI-Projekt herzustellen.
   ...
   with agent_client:
    ...
    Der Code stellt mithilfe der aktuellen Azure-Anmeldeinformationen eine Verbindung mit dem Foundry-Projekt her. Die abschließende Anweisung *mit agent_client* startet einen Codeblock, der den Geltungsbereich des Clients definiert und sicherstellt, dass dieser bereinigt wird, wenn der Code innerhalb des Blocks beendet ist.
