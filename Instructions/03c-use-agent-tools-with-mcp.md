...
1. Kopieren Sie den Wert für **Azure AI Foundry-Projektendpunkt**. Er wird verwendet, um eine Verbindung mit Ihrem Projekt in einer Clientanwendung herzustellen.
